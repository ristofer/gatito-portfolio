    ...
    return (
        <div className="flex flex-row justify-center lg:justify-between bg-purple-800">
            ...
            <div className="w-full lg:flex lg:flex-col md:w-1/3 text-center md:text-left mx-auto lg:p-20">
                <h1 className="text-4xl md:text-8xl font-bold text-gray-400 my-2">
                    Fullstack Dev
                </h1>
                <h1 className="text-4xl md:text-8xl font-bold text-red-200 my-2">
                    Cristopher
                </h1>
                <h1 className="text-4xl md:text-8xl font-bold text-blue-200 my-2">
                    Gómez
                </h1>
            </div>
